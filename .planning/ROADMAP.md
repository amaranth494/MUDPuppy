...
- [x] **Phase 5: Coaching Channel** - AI-chatter conversation above AI-player in the AI panel: guidance lands in the next decision, Pause/Resume on AI-player, plain-text chat with a help article (no promotion) (completed 2026-09-18)
...
- [x] 04-03-PLAN.md — The AI keeps playing on its own, paced to the game's output, and stops the instant the wheel is grabbed

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 04-04-PLAN.md — The mechanical limits stop the loop and the owner sees why
- [x] 04-05-PLAN.md — The AI reads only what just happened, and never an empty screen

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 04-06-PLAN.md — The owner sets a session goal, and it names the active Quest

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 04-07-PLAN.md — Every prompt carries the goal, the Quest's bullets and Session Memory, all framed as untrusted
...
- [x] 04-09-PLAN.md — Captured game text ages out on a schedule, and the owner can delete it now

**Wave 8** *(blocked on Wave 7 completion)*

- [x] 04-10-PLAN.md — One command turns the Phase 4 HTTP surface into a canned PASS/FAIL report per criterion
...
- [x] 05-01-PLAN.md — The owner can pause AI-player, and it only starts again when every reason to wait is gone
- [x] 05-02-PLAN.md — The safety checker stops blocking ordinary fights, and an answer that never said no no longer sends the command
- [x] 05-03-PLAN.md — No host runs on a made-up vault key, and a signed-out visitor never reads a log page

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 05-04-PLAN.md — The AI's own commands are counted against a speed limit the owner can set
...
- [x] 05-06-PLAN.md — A coaching line reaches AI-player's next decision, and the owner can take it back in words

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 05-07-PLAN.md — One panel, two views: the thinking stream on top, the conversation below, with Pause and Coaching in effect
- [x] 05-10-PLAN.md — One command turns the reachable half of this phase into a canned report

**Wave 6** *(blocked on Wave 5 completion)*

- [x] 05-08-PLAN.md — Either view can be popped into its own window and works the same there
- [x] 05-09-PLAN.md — The Help page explains the two levels and the by-hand copy, and the Logs page shows the conversation

**Wave 7** *(blocked on Wave 6 completion)*

- [x] 05-11-PLAN.md — The phase is demonstrated on staging and the evidence and security agenda are filed
